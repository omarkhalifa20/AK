    ...
    <>
      <div className="w-full h-full flex flex-col">
        <div className="flex flex-col flex-grow h-full">
          ...
          <div className='grid grid-cols-12 gap-1 lg:gap-2 px-3  justify-center lg:mx-auto items-center mt-auto mb-2'>
          <AlertDialog>
              ...
              <AlertDialogContent 
                onClick={(e) => e.stopPropagation()} 
                className='Playpen max-h-[90vh] mt-4 overflow-y-auto'
              >
                ...
                <div className='grid grid-cols-12 gap-1 lg:gap-3 lg:p-2 justify-center  lg:flex rounded-2xl w-full col-span-12 lg:col-span-4 '>
                
             
                  <button onClick={handleAddToCart} className='cursor-pointer rounded-xl  py-[2px] lg:p-2 col-span-12  lg:col-span-6 flex justify-center lg:block bg-gray-300  '> 
                  {loading ? (
              <Loader3 />
            ) : (
                  ...
                  <button onClick={handleAddToWishlist} className='cursor-pointer rounded-xl  py-[2px] lg:p-2 flex justify-center items-center lg:block bg-gray-300  col-span-12  lg:col-span-6'>
                  {loading2 ? (
              <Loader3 />
            ) : (
                    <Heart 
